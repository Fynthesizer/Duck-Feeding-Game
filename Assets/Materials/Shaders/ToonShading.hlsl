...
in float ToonRampOffset, in float MinValue, in float MaxValue, out float3 ToonRampOutput, out float3 Direction)
{
    ...
    // set the shader graph node previews
        ...
        toonRamp = MinValue + toonRamp * (MaxValue - MinValue);
